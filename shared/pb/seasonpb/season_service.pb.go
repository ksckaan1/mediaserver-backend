...
const file_season_service_proto_rawDesc = "" +
	"\n" +
	"\x14season_service.proto\x12\bseasonpb\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"j\n" +
	"\x13CreateSeasonRequest\x12\x1b\n" +
	"\tseries_id\x18\x01 \x01(\tR\bseriesId\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\"3\n" +
	"\x14CreateSeasonResponse\x12\x1b\n" +
	"\tseason_id\x18\x01 \x01(\tR\bseasonId\"3\n" +
	"\x14GetSeasonByIDRequest\x12\x1b\n" +
	"\tseason_id\x18\x01 \x01(\tR\bseasonId\"\xf9\x01\n" +
	"\x06Season\x12\x0e\n" +
	...
	"\x05order\x18\a \x01(\x05R\x05order\";\n" +
	"\x1cListSeasonsBySeriesIDRequest\x12\x1b\n" +
	"\tseries_id\x18\x01 \x01(\tR\bseriesId\"2\n" +
	"\n" +
	"SeasonList\x12$\n" +
	"\x04list\x18\x01 \x03(\v2\x10.seasonpb.SeasonR\x04list\"n\n" +
	"\x17UpdateSeasonByIDRequest\x12\x1b\n" +
	"\tseason_id\x18\x01 \x01(\tR\bseasonId\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\"]\n" +
	"\x1fReorderSeasonsBySeriesIDRequest\x12\x1b\n" +
